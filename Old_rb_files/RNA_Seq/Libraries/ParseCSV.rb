...
module ParseCSV
  ...
  # @param data_header [String] the string name of the header the data
  # @param alpha_num_header [String] optional the name of the header
  #                         containing well location.
  ...
  # Does initial formatting and parsing of csv files
  #
  # @param csv_uploads [Upload] raw uploaded csv files
  # @return [Array<csv, Hash>] returns an array containing the semi parsed csv
